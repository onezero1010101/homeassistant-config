...
<script type="text/javascript">RED.nodes.registerType("server-events",{category:"home_assistant",color:"#038FC7",defaults:{name:{value:""},server:{value:"",type:"server",required:!0},event_type:{value:"",required:!1},exposeToHomeAssistant:{value:!1},haConfig:{value:[{property:"name",value:""},{property:"icon",value:""}]}},inputs:0,outputs:1,icon:"ha-events-all.svg",paletteLabel:"events: all",label:function(){return this.name||`events: ${this.event_type||"all"}`},labelStyle:nodeVersion.labelStyle,oneditprepare:function(){haServer.init(this,"#node-input-server"),exposeNode.init(this),$("#node-input-event_type").on("change keyup",(function(){$("#eventAlert").toggle(0===$(this).val().length)})).trigger("change")},oneditsave:function(){this.haConfig=exposeNode.getValues()}});</script>
