...
<script type="text/javascript">RED.nodes.registerType("ha-get-entities",{category:"home_assistant",color:"#52C0F2",inputs:1,outputs:1,icon:"ha-get-entities.svg",paletteLabel:"get entities",label:function(){return this.name||"get entities"},labelStyle:nodeVersion.labelStyle,defaults:{server:{value:"",type:"server",required:!0},name:{value:""},rules:{value:[{property:"",logic:"is",value:"",valueType:"str"}]},output_type:{value:"array"},output_empty_results:{value:!1},output_location_type:{value:"msg"},output_location:{value:"payload"},output_results_count:{value:1,validate:function(t){return"random"!==$("#node-input-output_type").val()||Number.isInteger(Number(t))}}},oneditprepare:function(){const t=[{value:"is",text:"is"},{value:"is_not",text:"is not"},{value:"lt",text:"<"},{value:"lte",text:"<="},{value:"gt",text:">"},{value:"gte",text:">="},{value:"includes",text:"in"},{value:"does_not_include",text:"not in"},{value:"starts_with",text:"starts with"},{value:"in_group",text:"in group"},{value:"jsonata",text:"JSONata"}],e={value:"entity",label:"entity."},a=["str","num","bool","re","jsonata","msg","flow","global",e],o=$("#logic");let n=[];haServer.init(this,"#node-input-server"),haServer.autocomplete("properties",t=>{n=t,$(".input-property").autocomplete({source:n,minLength:0})}),o.editableList({addButton:!0,removable:!0,height:321,addItem:function(o,u,s){const l=$("<div />").appendTo(o),i=$("<div />",{style:"margin-top: 10px;"}).appendTo(o);Object.prototype.hasOwnProperty.call(s,"logic")||(s.logic="is"),$("<span />",{text:"Property",style:"padding-right: 47px;"}).appendTo(l);const p=$("<input />",{type:"text",class:"input-property",style:"margin-left: 5px;"}).appendTo(l).val(s.property);p.autocomplete({source:n,minLength:0});const r=$("<select/>",{style:"margin-right: 5px;width: auto;"}).appendTo(i).change((function(t){let o=a;switch(p.prop("disabled","jsonata"===t.target.value),t.target.value){case"is":case"is_not":break;case"lt":case"lte":case"gt":case"gte":o=["num","jsonata","msg","flow","global",e];break;case"includes":case"does_not_include":case"starts_with":case"in_group":o=["str","jsonata","msg","flow","global",e];break;case"jsonata":o=["jsonata"]}d.typedInput("types",o)}));for(var c in t)r.append($("<option></option>").val(t[c].value).text(t[c].text));const d=$("<input />",{class:"input-value",type:"text",style:"width: 70%;"}).appendTo(i).val(s.value).typedInput({types:a});d.typedInput("type",s.valueType),r.val(s.logic).trigger("change")}}),o.editableList("addItems",this.rules),$("#node-input-output_location").typedInput({types:["msg","flow","global"],typeField:"#node-input-output_location_type"}),$("#node-input-output_results_count").spinner({min:1}),$("#node-input-output_type").on("change",(function(t){switch($(".output-option").hide(),t.target.value){case"array":$("#output_empty_results").show(),$("#output_location").show();break;case"count":$("#output_location").show();break;case"random":$("#output_results_count").show(),$("#output_location").show()}})).trigger("change")},oneditsave:function(){const t=$("#logic").editableList("items"),e=this;e.rules=[],t.each((function(t){const a=$(this),o=a.find(".input-property").val(),n=a.find("select").val(),u=a.find(".input-value").typedInput("value"),s=a.find(".input-value").typedInput("type");e.rules.push({property:o,logic:n,value:u,valueType:s})}))}});</script>
